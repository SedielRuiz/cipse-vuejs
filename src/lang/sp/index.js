...
export default {
   ...
   manageUsers: "Gestion usuarios",
   usersmanageUsers: "Gestion de usuarios / Consulta",
   consult: "Consulta",
   usersNewUser: "Gestion de usuarios / Nuevo",
   usersUpdateUser: "Gestion de usuarios / Consulta / Actualizar",
   newUser: "Nuevo usuario",
   notices: "Noticias",
   notice: "Noticia",
   requests: "Solicitudes",
   request: "Solicitud",
   manageContents: "Gestión contenidos",
   doctrinal: "Doctrinal",
   memories: "Memorias",
   us: "Nosotros",
   manageRequest: "Gestión solicitudes",
   actions: "Acciones",
   name: "Nombre",
   document: "Documento",
   contents: "Contenidos",
   ...
   newObservatory:"Nuevo observatorio",
   editObservatory:"Editar observatorio",
   crime:"Crimen",
   crimes:"Crimenes",
   year:"Año",
   january: "Enero",
