<template>
	<div class="row session-wrapper-container">
        ...
        <div class="col-xs-12 col-sm-12 col-md-4" style="padding: 5rem 2rem !important;">
            <div class="session-block container">
                <div class="text-center mb-30">
                    <div class="mb-20">
                        <img class="img-fluid rounded-circle" width="250" height="250" src="/static/img/LogoCIPSE_800.png" />
                    </div>
