        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <b-card class="mt-3" >
                ...
                <b-form @submit="processContent" @reset="onBack">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4">
                            <b-form-group id="input-group-language" label="Idioma:" label-for="language">
                                <select class="form-control" id="language" v-model="content.language_id" required>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-4">
                            <b-form-group id="input-group-category" label="Categoría:" label-for="category">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4">
                            <b-form-group id="input-group-title" label="Titulo:" label-for="title">
                                <b-form-input
                                id="title"
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4">
                            <b-form-group id="input-group-description-title" label="Descripción:" label-for="description_title">
                                <b-form-input
                                id="description_title"
                                v-model="content.description_title"
                                required
                                placeholder=""
                                ></b-form-input>
                            </b-form-group>
                    ...
                    <b-form-group id="input-group-notice" label="Contenido:" label-for="notice">
                        <quill-editor v-model="data" ref="myQuillEditor" :options="editorOption" 
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            processContent () {
                console.log("contenido editor ", this.data);
                // if(this.edit){
